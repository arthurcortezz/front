...
@Component({
  selector: 'acs-navigation-switcher-mode',
...
export class AcsNavigationSwitcherModeComponent implements OnInit {
  @Input() hovered: boolean;
  private readonly unsubscribeAll: Subject<any> = new Subject<any>();
  public mode: string;

  constructor(private readonly configService: AcsConfigService) {
