...
import { AcsMockApiReplyCallback } from '@acs/mock-api/mock-api.types';

export class AcsMockApiHandler {
  public request!: HttpRequest<any>;
  public urlParams!: { [key: string]: string };

  private _reply: AcsMockApiReplyCallback = undefined;
  ...
  reply(callback: AcsMockApiReplyCallback): void {
